...
#else
  docker build --pull --rm --build-arg PANGOLIN_VERSION="${PANGOLIN_VERSION}" --build-arg PANGOLIN_DATA_VERSION="${PANGOLIN_DATA_VERSION}" -t registry.gitlab.com/cgps/cog-uk/pangolin:"${IMAGE_TAG}" . || exit 1
